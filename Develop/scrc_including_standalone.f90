...
TYPE (MESH_TYPE),  POINTER :: M=>NULL()                  !< Pointer to specified mesh (based on MESHES from surrounding FDS code)
...
TYPE (SCARC_LEVEL_TYPE),    POINTER :: L=>NULL()         !< Pointer to specified grid level
TYPE (SCARC_LEVEL_TYPE),    POINTER :: LF=>NULL()        !< Pointer to specified fine grid level
TYPE (SCARC_LEVEL_TYPE),    POINTER :: LC=>NULL()        !< Pointer to specified coarse grid level
TYPE (SCARC_LEVEL_TYPE),    POINTER :: OL=>NULL()        !< Pointer to specified grid level on neighboring mesh
TYPE (SCARC_LEVEL_TYPE),    POINTER :: OLF=>NULL()       !< Pointer to specified fine grid level on neighboring mesh
TYPE (SCARC_LEVEL_TYPE),    POINTER :: OLC=>NULL()       !< Pointer to specified coarse grid level on neighboring mesh

TYPE (SCARC_GRID_TYPE),     POINTER :: G=>NULL()         !< Pointer to specified grid discretization 
TYPE (SCARC_GRID_TYPE),     POINTER :: GF=>NULL()        !< Pointer to specified grid discretization 
TYPE (SCARC_GRID_TYPE),     POINTER :: GC=>NULL()        !< Pointer to specified grid discretization 
TYPE (SCARC_GRID_TYPE),     POINTER :: OG=>NULL()        !< Pointer to specified grid discretization 
TYPE (SCARC_GRID_TYPE),     POINTER :: OGF=>NULL()       !< Pointer to specified grid discretization 
TYPE (SCARC_GRID_TYPE),     POINTER :: OGC=>NULL()       !< Pointer to specified grid discretization 
...
! ------------------------------------------------------------------------------------------------
!> \brief Pack overlapping parts of cell numbers
! ------------------------------------------------------------------------------------------------
...
! ------------------------------------------------------------------------------------------------
!> \brief Unpack overlapping parts of cell numbers
! ------------------------------------------------------------------------------------------------
