...
INTEGER  :: I,J,K,IZERO,IOS,N_INIT_RESERVED,MAX_LEAK_PATHS,I_DUM(10),IERROR,N_EVAC_ZONE
...
NAMELIST /MISC/ AEROSOL_AL2O3,AEROSOL_SCRUBBING,AGGLOMERATION,ALIGNMENT_TOLERANCE,ALLOW_SURFACE_PARTICLES, &
                ...
                CNF_CUTOFF,COMPUTE_CUTCELLS_ONLY,CONSTANT_H_SOLID_TO_DROPLET,CONSTANT_SPECIFIC_HEAT_RATIO,&
                ...
                NEAR_WALL_TURBULENCE_MODEL,NORTH_BEARING,&
...
REAL(EB) :: DIAMETER, GAMMA_D,AGE,INITIAL_TEMPERATURE,HEAT_OF_COMBUSTION, &
            ...
            PRIMARY_BREAKUP_DRAG_REDUCTION_FACTOR,H_SOLID_TO_DROPLET
...
READ_PART_LOOP: DO N=1,N_LAGRANGIAN_CLASSES
   ...
   LPC%H_SOLID_TO_DROPLET  = H_SOLID_TO_DROPLET*1000._EB
...
H_SOLID_TO_DROPLET       = 0.3_EB       ! kW/m2K
...
NAMELIST /SURF/ ADIABATIC,BACKING,BLOWING,BURN_AWAY,BURN_DURATION,CELL_SIZE_FACTOR,&
                C_FORCED_CONSTANT,C_FORCED_PR_EXP,C_FORCED_RE,C_FORCED_RE_EXP,C_HORIZONTAL,C_VERTICAL,COLOR,&
...
SUBROUTINE REORDER_SLICEVALS(MULTI_RES_ORDER,NI,NJ,NK)
INTEGER, INTENT(IN) :: NI, NJ, NK
INTEGER, INTENT(OUT), DIMENSION(NI*NJ*NK) :: MULTI_RES_ORDER

INTEGER, DIMENSION(NI*NJ*NK) :: MULTI_RES_ORDER_COPY
INTEGER :: I, J, K
INTEGER :: II, JJ, KK
INTEGER :: NI2, NJ2, NK2
...
MULTI_RES_ORDER_COPY(1:NI*NJ*NK) = 0
NI2 = 2
NJ2 = 2
NK2 = 2
NI_LIST(1) = 1
   ...
   DO WHILE (FINISH .EQ. 0)
      DO KK = 1, NK2
         ...
         DO JJ = 1, NJ2
            J = NJ_LIST(JJ)
            INDEX = (K-1)*NJ + J
            IF(MULTI_RES_ORDER_COPY(INDEX) .EQ. 0) THEN
               MULTI_RES_ORDER_COPY(INDEX) = COUNT
               COUNT = COUNT + 1
            ENDIF
         END DO
      END DO
...
ENDIF
DO I = 1, NI*NJ*NK
   INDEX = MULTI_RES_ORDER_COPY(I)
   MULTI_RES_ORDER(INDEX) = I
END DO
      ...
      VECTORLOOP: DO ITER=1,NITER
         ...
         IF (MULTI_RES) THEN
            IF (SL%I1 .NE. SL%I2 .AND. SL%J1 .NE. SL%J2 .AND. SL%K1 .NE. SL%K2 ) THEN
               ...
               CALL SHUTDOWN(MESSAGE) ; RETURN
            ENDIF
            ALLOCATE(SL%MULTI_RES_ORDER((SL%I2+1-SL%I1)*(SL%J2+1-SL%J1)*(SL%K2+1-SL%K1)),STAT=IZERO)
            CALL REORDER_SLICEVALS(SL%MULTI_RES_ORDER,(SL%I2+1-SL%I1),(SL%J2+1-SL%J1),(SL%K2+1-SL%K1))
         ENDIF
