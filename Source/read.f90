...
READ_SURF_LOOP: DO N=0,N_SURF
   ...
   IF (.NOT.VEG_LSET_COUPLED) VEG_LEVEL_SET_COUPLED = .FALSE.
...
USE SCRC, ONLY: SCARC_METHOD, SCARC_GRID, SCARC_MATRIX, SCARC_ERROR_FILE, SCARC_PRECEDING_FFT, SCARC_ACCURACY, &
                ...
                SCARC_MULTIGRID_PRESMOOTH, SCARC_MULTIGRID_POSTSMOOTH, &
...
NAMELIST /PRES/ BAROCLINIC,CHECK_POISSON,FISHPAK_BC,ITERATION_SUSPEND_FACTOR,LAPLACE_PRESSURE_CORRECTION, &
                SCARC_METHOD, SCARC_GRID, SCARC_MATRIX, SCARC_ERROR_FILE, SCARC_PRECEDING_FFT, SCARC_ACCURACY, &
                SCARC_KRYLOV, SCARC_KRYLOV_ITERATIONS, SCARC_KRYLOV_ACCURACY, SCARC_KRYLOV_INTERPOL, &
                SCARC_MULTIGRID, SCARC_MULTIGRID_ITERATIONS, SCARC_MULTIGRID_ACCURACY, SCARC_PRECISION, SCARC_TWOLEVEL, &
                SCARC_MULTIGRID_CYCLE, SCARC_MULTIGRID_LEVEL, SCARC_MULTIGRID_COARSENING, SCARC_MULTIGRID_INTERPOL, &
                SCARC_MULTIGRID_PRESMOOTH, SCARC_MULTIGRID_POSTSMOOTH, &
...
NAMELIST /SLCF/ AGL_SLICE,CELL_CENTERED,DB,EVACUATION,FACE_CENTERED,FYI,ID,IOR,MAXIMUM_VALUE,MATL_ID,MESH_NUMBER,&
                MINIMUM_VALUE,PART_ID,PBX,PBY,PBZ,PROP_ID,QUANTITY,QUANTITY2,REAC_ID,RLE_MIN,RLE_MAX,SLICETYPE,SMV_OFFSET,&
