...
IF (DEBUG) THEN
     IF (MESHES(MYID+1)%IBAR < 10) THEN
        CFORM1 = "( E16.8)"  ; WRITE(CFORM1(2:2),'(I1.1)') MESHES(MYID+1)%IBAR
     ELSE
        CFORM1 = "(  E16.8)" ; WRITE(CFORM1(2:3),'(I2.2)') MESHES(MYID+1)%IBAR
     ENDIF
     IF (MESHES(MYID+1)%IBAR+1 < 10) THEN
        CFORM2 = "( E16.8)"  ; WRITE(CFORM2(2:2),'(I1.1)') MESHES(MYID+1)%IBAR+1
     ELSE
        CFORM2 = "(  E16.8)" ; WRITE(CFORM2(2:3),'(I2.2)') MESHES(MYID+1)%IBAR+1
     ENDIF
     IF (MESHES(MYID+1)%IBAR+2 < 10) THEN
        CFORM3 = "( E16.8)"  ; WRITE(CFORM3(2:2),'(I1.1)') MESHES(MYID+1)%IBAR+2
     ELSE
        CFORM3 = "(  E16.8)" ; WRITE(CFORM3(2:3),'(I2.2)') MESHES(MYID+1)%IBAR+2
     ENDIF
     WRITE(*,*) 'CFORM1=', CFORM1
     WRITE(*,*) 'CFORM2=', CFORM2
     WRITE(*,*) 'CFORM3=', CFORM3
