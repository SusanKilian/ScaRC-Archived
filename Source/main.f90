...
DEBUG = DEBUG0 .AND. (MYID == 0)
IF (DEBUG) THEN
     IF (MESHES(MYID+1)%IBAR < 10) THEN
        CFORM1 = "( E14.6)"  ; WRITE(CFORM1(2:2),'(I1.1)') MESHES(MYID+1)%IBAR
     ELSE
        CFORM1 = "(  E14.6)" ; WRITE(CFORM1(2:3),'(I2.2)') MESHES(MYID+1)%IBAR
     ENDIF
     IF (MESHES(MYID+1)%IBAR+1 < 10) THEN
        CFORM2 = "( E14.6)"  ; WRITE(CFORM2(2:2),'(I1.1)') MESHES(MYID+1)%IBAR+1
     ELSE
        CFORM2 = "(  E14.6)" ; WRITE(CFORM2(2:3),'(I2.2)') MESHES(MYID+1)%IBAR+1
     ENDIF
     IF (MESHES(MYID+1)%IBAR+2 < 10) THEN
        CFORM3 = "( E14.6)"  ; WRITE(CFORM3(2:2),'(I1.1)') MESHES(MYID+1)%IBAR+2
     ELSE
        CFORM3 = "(  E14.6)" ; WRITE(CFORM3(2:3),'(I2.2)') MESHES(MYID+1)%IBAR+2
     ENDIF
     WRITE(*,*) 'CFORM1=', CFORM1
     WRITE(*,*) 'CFORM2=', CFORM2
     WRITE(*,*) 'CFORM3=', CFORM3
...
IF (DEBUG) THEN
   WRITE(*,*) 'FVX:1'
   WRITE(*,CFORM2) ((MESHES(1)%FVX(III,1,KKK), III=0, MESHES(1)%IBAR), KKK=MESHES(1)%KBAR,0,-1)
ENDIF
...
IF (DEBUG) THEN
   ...
   WRITE(*,CFORM2) ((MESHES(1)%FVX(III,1,KKK), III=0, MESHES(1)%IBAR), KKK=MESHES(1)%KBAR,0,-1)
   WRITE(*,*) 'U(.,0,.):7'
   WRITE(*,CFORM2) ((MESHES(1)%U(III,0,KKK), III=0, MESHES(1)%IBAR), KKK=MESHES(1)%KBAR,0,-1)
   WRITE(*,*) 'U(.,1,.):7'
   WRITE(*,CFORM2) ((MESHES(1)%U(III,1,KKK), III=0, MESHES(1)%IBAR), KKK=MESHES(1)%KBAR,0,-1)
   WRITE(*,*) 'U(.,2,.):7'
   WRITE(*,CFORM2) ((MESHES(1)%U(III,2,KKK), III=0, MESHES(1)%IBAR), KKK=MESHES(1)%KBAR,0,-1)
   WRITE(*,*) 'US(.,0,.):7'
   WRITE(*,CFORM2) ((MESHES(1)%US(III,0,KKK), III=0, MESHES(1)%IBAR), KKK=MESHES(1)%KBAR,0,-1)
   WRITE(*,*) 'US(.,1,.):7'
   WRITE(*,CFORM2) ((MESHES(1)%US(III,1,KKK), III=0, MESHES(1)%IBAR), KKK=MESHES(1)%KBAR,0,-1)
   WRITE(*,*) 'US(.,2,.):7'
   WRITE(*,CFORM2) ((MESHES(1)%US(III,2,KKK), III=0, MESHES(1)%IBAR), KKK=MESHES(1)%KBAR,0,-1)
ENDIF
...
IF (DEBUG) THEN
   WRITE(*,*) 'FVX(.,0,.)::8'
   WRITE(*,CFORM2) ((MESHES(1)%FVX(III,0,KKK), III=0, MESHES(1)%IBAR), KKK=MESHES(1)%KBAR,0,-1)
   WRITE(*,*) 'FVX(.,1,.)::8'
   WRITE(*,CFORM2) ((MESHES(1)%FVX(III,1,KKK), III=0, MESHES(1)%IBAR), KKK=MESHES(1)%KBAR,0,-1)
   WRITE(*,*) 'FVX(.,2,.)::8'
   WRITE(*,CFORM2) ((MESHES(1)%FVX(III,2,KKK), III=0, MESHES(1)%IBAR), KKK=MESHES(1)%KBAR,0,-1)
   WRITE(*,*) 'U(.,0,.):8'
   WRITE(*,CFORM2) ((MESHES(1)%U(III,0,KKK), III=0, MESHES(1)%IBAR), KKK=MESHES(1)%KBAR,0,-1)
   WRITE(*,*) 'U(.,1,.):8'
   WRITE(*,CFORM2) ((MESHES(1)%U(III,1,KKK), III=0, MESHES(1)%IBAR), KKK=MESHES(1)%KBAR,0,-1)
...
IF (DEBUG) THEN
   WRITE(*,*) 'AFTER MESH_EXCHANGE(5)'
   WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:5: FVX'
   WRITE(*,CFORM2) ((MESHES(1)%FVX(III,1,KKK), III=0, MESHES(1)%IBAR), KKK=MESHES(1)%KBAR,0,-1)
   WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:5: U'
   WRITE(*,CFORM2) ((MESHES(1)%U(I,1,K), I=0, MESHES(1)%IBAR), K=MESHES(1)%KBAR,0,-1)
   WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:5: US'
   WRITE(*,CFORM2) ((MESHES(1)%US(I,1,K), I=0, MESHES(1)%IBAR), K=MESHES(1)%KBAR,0,-1)
ENDIF
      DO NM=LOWER_MESH_INDEX,UPPER_MESH_INDEX
         IF (EVACUATION_ONLY(NM) .OR. EVACUATION_SKIP(NM)) CYCLE
...
IF (DEBUG) THEN
   ...
   WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:5: US'
   WRITE(*,CFORM2) ((MESHES(1)%US(I,1,K), I=0, MESHES(1)%IBAR), K=MESHES(1)%KBAR,0,-1)
   WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:5: H(.,0,.)'
   WRITE(*,*) '-------------------------------------------------------'
   WRITE(*,CFORM3) ((MESHES(1)%H(I,0,K), I=0, MESHES(1)%IBAR+1), K=MESHES(1)%KBAR+1,0,-1)
   WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:5: H(.,1,.)'
   WRITE(*,CFORM3) ((MESHES(1)%H(I,1,K), I=0, MESHES(1)%IBAR+1), K=MESHES(1)%KBAR+1,0,-1)
   WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:5: H(.,2,.)'
   WRITE(*,CFORM3) ((MESHES(1)%H(I,2,K), I=0, MESHES(1)%IBAR+1), K=MESHES(1)%KBAR+1,0,-1)
   WRITE(*,*) '-------------------------------------------------------'
   WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:5: HS(.,0,.)'
   WRITE(*,CFORM3) ((MESHES(1)%HS(I,0,K), I=0, MESHES(1)%IBAR+1), K=MESHES(1)%KBAR+1,0,-1)
   WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:5: HS(.,1,.)'
   WRITE(*,CFORM3) ((MESHES(1)%HS(I,1,K), I=0, MESHES(1)%IBAR+1), K=MESHES(1)%KBAR+1,0,-1)
   WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:5: HS(.,2,.)'
   WRITE(*,CFORM3) ((MESHES(1)%HS(I,2,K), I=0, MESHES(1)%IBAR+1), K=MESHES(1)%KBAR+1,0,-1)
ENDIF
...
IF (DEBUG) THEN
   WRITE(*,*) '%%%%%%% AFTER COMPUTE_VELOCITY_ERROR'
   WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:6: FVX'
   WRITE(*,CFORM2) ((MESHES(1)%FVX(III,1,KKK), III=0, MESHES(1)%IBAR), KKK=MESHES(1)%KBAR,0,-1)
   WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:6: U'
   WRITE(*,CFORM2) ((MESHES(1)%U(I,1,K), I=0, MESHES(1)%IBAR), K=MESHES(1)%KBAR,0,-1)
   WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:6: US'
   WRITE(*,CFORM2) ((MESHES(1)%US(I,1,K), I=0, MESHES(1)%IBAR), K=MESHES(1)%KBAR,0,-1)
   WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:6: H'
   WRITE(*,CFORM3) ((MESHES(1)%H(I,1,K), I=0, MESHES(1)%IBAR+1), K=MESHES(1)%KBAR+1,0,-1)
   WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:6: HS'
   WRITE(*,CFORM3) ((MESHES(1)%HS(I,1,K), I=0, MESHES(1)%IBAR+1), K=MESHES(1)%KBAR+1,0,-1)
ENDIF
