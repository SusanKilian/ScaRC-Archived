...
WRITE(*,'(8E14.6)') ((MESHES(1)%FVX(I,1,K), I=1, 8), K=1,8)
WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:1: FVY'
WRITE(*,'(8E14.6)') ((MESHES(1)%FVZ(I,1,K), I=1, 8), K=1,8)
WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:1: U'
WRITE(*,'(9E14.6)') ((MESHES(1)%U(I,1,K), I=0, 8), K=0,8)
WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:1: US'
WRITE(*,'(9E14.6)') ((MESHES(1)%US(I,1,K), I=0, 8), K=0,8)
WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:1: W'
WRITE(*,'(9E14.6)') ((MESHES(1)%W(I,1,K), I=0, 8), K=0,8)
WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:1: WS'
WRITE(*,'(9E14.6)') ((MESHES(1)%WS(I,1,K), I=0, 8), K=0,8)
WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:1: H'
WRITE(*,'(10E14.6)') ((MESHES(1)%H(I,1,K), I=0, 9), K=0,9)
WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:1: HS'
WRITE(*,'(10E14.6)') ((MESHES(1)%HS(I,1,K), I=0, 9), K=0,9)
WRITE(*,*) ' ........... starting ScaRC ............', PRESSURE_ITERATIONS
   ...
   SELECT CASE(PRES_METHOD)
      CASE ('FFT')
         ...
         ENDDO
      CASE ('SCARC','USCARC')
         CALL SCARC_SOLVER(DT, PRESSURE_ITERATIONS, TOTAL_PRESSURE_ITERATIONS)
         CALL STOP_CHECK(1)
      CASE ('GLMAT')
         CALL GLMAT_SOLVER_H
