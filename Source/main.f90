...
WRITE(*,'(6E14.6)') ((MESHES(1)%FVX(I,1,K), I=0, MESHES(1)%IBAR), K=MESHES(1)%KBAR,0,-1)
WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:5: U'
WRITE(*,'(6E14.6)') ((MESHES(1)%U(I,1,K), I=0, MESHES(1)%IBAR), K=MESHES(1)%KBAR,0,-1)
WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:5: US'
WRITE(*,'(6E14.6)') ((MESHES(1)%US(I,1,K), I=0, MESHES(1)%IBAR), K=MESHES(1)%KBAR,0,-1)
ELSE
WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:5: FVX'
WRITE(*,'(11E14.6)') ((MESHES(1)%FVX(I,1,K), I=0, MESHES(1)%IBAR), K=MESHES(1)%KBAR,0,-1)
WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:5: U'
WRITE(*,'(11E14.6)') ((MESHES(1)%U(I,1,K), I=0, MESHES(1)%IBAR), K=MESHES(1)%KBAR,0,-1)
WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:5: US'
WRITE(*,'(11E14.6)') ((MESHES(1)%US(I,1,K), I=0, MESHES(1)%IBAR), K=MESHES(1)%KBAR,0,-1)
ENDIF
ENDIF
...
WRITE(*,'(6E14.6)') ((MESHES(1)%H(I,1,K), I=0, MESHES(1)%IBAR), K=MESHES(1)%KBAR,0,-1)
WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:5: HS'
WRITE(*,'(6E14.6)') ((MESHES(1)%HS(I,1,K), I=0, MESHES(1)%IBAR), K=MESHES(1)%KBAR,0,-1)
ELSE
WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:5: FVX'
WRITE(*,'(11E14.6)') ((MESHES(1)%FVX(I,1,K), I=0, MESHES(1)%IBAR), K=MESHES(1)%KBAR,0,-1)
WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:5: U'
...
WRITE(*,'(11E14.6)') ((MESHES(1)%US(I,1,K), I=0, MESHES(1)%IBAR), K=MESHES(1)%KBAR,0,-1)
WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:5: H'
WRITE(*,'(11E14.6)') ((MESHES(1)%H(I,1,K), I=0, MESHES(1)%IBAR), K=MESHES(1)%KBAR,0,-1)
WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:5: HS'
WRITE(*,'(11E14.6)') ((MESHES(1)%HS(I,1,K), I=0, MESHES(1)%IBAR), K=MESHES(1)%KBAR,0,-1)
ENDIF
ENDIF
