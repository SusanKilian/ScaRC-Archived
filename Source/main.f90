...
IF (DEBUG) THEN
   IF (MYID == 0) THEN
      WRITE(*,*) '%%%%%%% PRESSURE_ITERATION : START'
      WRITE(*,*) ' ........... starting ScaRC ............', PRESSURE_ITERATIONS, TOTAL_PRESSURE_ITERATIONS, PREDICTOR
      IF (NMESHES >1 ) THEN
         WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:5: FVX'
         WRITE(*,'(6E16.8)') ((MESHES(1)%FVX(I,1,K), I=0, MESHES(1)%IBAR), K=MESHES(1)%KBAR,0,-1)
         WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:5: U'
         WRITE(*,'(6E16.8)') ((MESHES(1)%U(I,1,K), I=0, MESHES(1)%IBAR), K=MESHES(1)%KBAR,0,-1)
         WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:5: US'
         WRITE(*,'(6E16.8)') ((MESHES(1)%US(I,1,K), I=0, MESHES(1)%IBAR), K=MESHES(1)%KBAR,0,-1)
      ELSE
         WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:5: FVX'
         WRITE(*,'(11E16.8)') ((MESHES(1)%FVX(I,1,K), I=0, MESHES(1)%IBAR), K=MESHES(1)%KBAR,0,-1)
         WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:5: U'
         WRITE(*,'(11E16.8)') ((MESHES(1)%U(I,1,K), I=0, MESHES(1)%IBAR), K=MESHES(1)%KBAR,0,-1)
         WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:5: US'
         WRITE(*,'(11E16.8)') ((MESHES(1)%US(I,1,K), I=0, MESHES(1)%IBAR), K=MESHES(1)%KBAR,0,-1)
      ENDIF
   ENDIF
ENDIF
...
IF (DEBUG) THEN
   IF (MYID == 0) THEN
      WRITE(*,*) ' ........... leaving ScaRC ............', PRESSURE_ITERATIONS, TOTAL_PRESSURE_ITERATIONS, PREDICTOR
      IF (NMESHES > 1) THEN
         WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:5: FVX'
         WRITE(*,'(6E16.8)') ((MESHES(1)%FVX(I,1,K), I=0, MESHES(1)%IBAR), K=MESHES(1)%KBAR,0,-1)
         WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:5: U'
         ...
         WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:5: US'
         WRITE(*,'(6E16.8)') ((MESHES(1)%US(I,1,K), I=0, MESHES(1)%IBAR), K=MESHES(1)%KBAR,0,-1)
         WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:5: H'
         WRITE(*,'(7E16.8)') ((MESHES(1)%H(I,1,K), I=0, MESHES(1)%IBAR+1), K=MESHES(1)%KBAR+1,0,-1)
         WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:5: HS'
         WRITE(*,'(7E16.8)') ((MESHES(1)%HS(I,1,K), I=0, MESHES(1)%IBAR+1), K=MESHES(1)%KBAR+1,0,-1)
      ELSE
         WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:5: FVX'
         WRITE(*,'(11E16.8)') ((MESHES(1)%FVX(I,1,K), I=0, MESHES(1)%IBAR), K=MESHES(1)%KBAR,0,-1)
         WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:5: U'
         ...
         WRITE(*,'(11E16.8)') ((MESHES(1)%US(I,1,K), I=0, MESHES(1)%IBAR), K=MESHES(1)%KBAR,0,-1)
         WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:5: H'
         WRITE(*,'(12E16.8)') ((MESHES(1)%H(I,1,K), I=0, MESHES(1)%IBAR+1), K=MESHES(1)%KBAR+1,0,-1)
         WRITE(*,*) 'PRESSURE_ITERATION_SCHEME:5: HS'
         WRITE(*,'(12E16.8)') ((MESHES(1)%HS(I,1,K), I=0, MESHES(1)%IBAR+1), K=MESHES(1)%KBAR+1,0,-1)
      ENDIF
   ENDIF
ENDIF
...
IF (MYID == 0) THEN
   WRITE(*,*) ' SUSISUSI: MAXVAL(VELOCITY_ERROR_MAX)', MAXVAL(VELOCITY_ERROR_MAX), ITERATE_PRESSURE
   WRITE(*,*) '           MAXVAL(PRESSURE_ERROR_MAX)', MAXVAL(PRESSURE_ERROR_MAX), ITERATE_PRESSURE
ENDIF
