...
#ifdef WITH_SCARC_DEBUG
   WRITE(MSG%LU_DEBUG,*) 'SUSISUSI: LOCAL_TO_GLOBAL', SIZE(GC%LOCAL_TO_GLOBAL), GC%NC, GC%NCE, GC%NCE2
   WRITE(MSG%LU_DEBUG,*) 'SUSISUSI: SIZE(PF%ROW)=', SIZE(PF%ROW)
   WRITE(MSG%LU_DEBUG,*) 'SUSISUSI: SIZE(PF%COL)=', SIZE(PF%COL)
   WRITE(MSG%LU_DEBUG,*) 'SUSISUSI: SIZE(PF%VAL)=', SIZE(PF%VAL)
   WRITE(MSG%LU_DEBUG,*) 'SUSISUSI: PF%N_VAL=', PF%N_VAL
   WRITE(MSG%LU_DEBUG,*) 'SUSISUSI: PF%N_ROW=', PF%N_ROW
