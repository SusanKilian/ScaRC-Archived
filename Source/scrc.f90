...
INTEGER, PARAMETER :: NSCARC_COARSENING_DOUBLED      =  2    !< Type of grid coarsening: default grid doubling (not AMG)
INTEGER, PARAMETER :: NSCARC_COARSENING_CUBIC        =  3    !< Type of grid coarsening: GMG-like cubic zones (AMG only)
