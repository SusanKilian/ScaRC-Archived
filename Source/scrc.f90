...
#ifdef WITH_SCARC_DEBUG
IF (PREDICTOR) THEN
   CALL SCARC_DEBUG_VECTOR3(MESHES(NM)%U , NM, NL, 'MGM: U  : SETUP_WORKSPACE')
   CALL SCARC_DEBUG_VECTOR3(MESHES(NM)%V , NM, NL, 'MGM: V  : SETUP_WORKSPACE')
   CALL SCARC_DEBUG_VECTOR3(MESHES(NM)%W , NM, NL, 'MGM: W  : SETUP_WORKSPACE')
ELSE
   CALL SCARC_DEBUG_VECTOR3(MESHES(NM)%US, NM, NL, 'MGM: US : SETUP_WORKSPACE')
   CALL SCARC_DEBUG_VECTOR3(MESHES(NM)%VS, NM, NL, 'MGM: VS : SETUP_WORKSPACE')
   CALL SCARC_DEBUG_VECTOR3(MESHES(NM)%WS, NM, NL, 'MGM: WS : SETUP_WORKSPACE')
ENDIF
#endif
               MGM => L%MGM
