...
IF (BSTATISTICS) THEN
   IF (MYID == 0) THEN
      ...
      WRITE(MSG%LU_STAT,*) '#Pres, #ScaRC, #CG, #MG, Level, #Smooth, Smoothing Type, #Coarse, #LU, Residual, Cappa'
   ENDIF
ENDIF
...
WRITE(MSG%LU_STAT,1000) ITE_PRES, ITE_TOTAL, ITE_CG, ITE_MG, NL, ITE_SMOOTH, ISM, ITE_COARSE, ITE_LU, RES, CAPPA

1000 FORMAT(9(I6,','), 2E14.4)
