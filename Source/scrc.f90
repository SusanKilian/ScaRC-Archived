...
ENDIF
      ...
      !CALL SCARC_MGM_UPDATE_GHOSTCELLS(NLEVEL_MIN, 2)
...
WRITE(MSG%LU_DEBUG,'(7E14.6)') ((M%FVX(I,1,K), I=0, M%IBAR+1), K=M%KBAR+1,1,-1)
WRITE(MSG%LU_DEBUG,*) 'SET_INTERNAL_VELO: FVZ'
WRITE(MSG%LU_DEBUG,'(7E14.6)') ((M%FVZ(I,1,K), I=0, M%IBAR+1), K=M%KBAR+1,1,-1)
WRITE(MSG%LU_DEBUG,*) 'SET_INTERNAL_VELO: UU'
WRITE(MSG%LU_DEBUG,'(7E14.6)') ((UU(I,1,K), I=0, M%IBAR+1), K=M%KBAR+1,1,-1)
WRITE(MSG%LU_DEBUG,*) 'SET_INTERNAL_VELO: WW'
WRITE(MSG%LU_DEBUG,'(7E14.6)') ((WW(I,1,K), I=0, M%IBAR+1), K=M%KBAR+1,1,-1)
WRITE(MSG%LU_DEBUG,*) 'SET_INTERNAL_VELO: HP-before'
WRITE(MSG%LU_DEBUG,'(7E14.6)') ((HP(I,1,K), I=0, M%IBAR+1), K=M%KBAR+1,1,-1)
#endif
...
WRITE(MSG%LU_DEBUG,'(7E14.6)') ((M%U(I,1,K), I=0, M%IBAR+1), K=M%KBAR+1,1,-1)
WRITE(MSG%LU_DEBUG,*) 'SET_INTERNAL_VELO: M%US'
WRITE(MSG%LU_DEBUG,'(7E14.6)') ((M%US(I,1,K), I=0, M%IBAR+1), K=M%KBAR+1,1,-1)
WRITE(MSG%LU_DEBUG,*) 'SET_INTERNAL_VELO: M%W'
WRITE(MSG%LU_DEBUG,'(7E14.6)') ((M%W(I,1,K), I=0, M%IBAR+1), K=M%KBAR+1,1,-1)
WRITE(MSG%LU_DEBUG,*) 'SET_INTERNAL_VELO: M%WS'
WRITE(MSG%LU_DEBUG,'(7E14.6)') ((M%WS(I,1,K), I=0, M%IBAR+1), K=M%KBAR+1,1,-1)
WRITE(MSG%LU_DEBUG,*) 'SET_INTERNAL_VELO: HP-before'
WRITE(MSG%LU_DEBUG,'(7E14.6)') ((HP(I,1,K), I=0, M%IBAR+1), K=M%KBAR+1,1,-1)
#endif
