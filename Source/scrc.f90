...
TYPE SCARC_MGM_TYPE
   ...
   REAL(EB), ALLOCATABLE, DIMENSION (:,:,:) :: U , V , W       !< Velocity vectors predictor
   REAL(EB), ALLOCATABLE, DIMENSION (:,:,:) :: US, VS, WS      !< Velocity vectors corrector
   REAL(EB), ALLOCATABLE, DIMENSION (:)     :: X1, X2          !< ScaRC solution vectors of different parts
   REAL(EB), ALLOCATABLE, DIMENSION (:)     :: UU, VV, WW      !< Velocity components along internal BC's
...
SELECT_METHOD: SELECT CASE (TYPE_METHOD)
   ...
   CASE (NSCARC_METHOD_MGM)
      ...
      IF (PRESSURE_ITERATIONS >0 ) THEN

#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) ' ----------------------- PART1 of MGM: BEFORE STRUCTURED', PRES_ON_WHOLE_DOMAIN
WRITE(MSG%LU_DEBUG,*) 'MGM-PART1: H'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((MESHES(MYID+1)%H(I,1,K), I=0, IBAR+1), K=KBAR+1,0,-1)
WRITE(MSG%LU_DEBUG,*) 'MGM-PART1: HS'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((MESHES(MYID+1)%HS(I,1,K), I=0, IBAR+1), K=KBAR+1,0,-1)
WRITE(MSG%LU_DEBUG,*) 'MGM-PART1: MGM%H1'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((MGM%H1(I,1,K), I=0, IBAR+1), K=KBAR+1,0,-1)
WRITE(MSG%LU_DEBUG,*) 'MGM-PART1: MGM%H2'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((MGM%H2(I,1,K), I=0, IBAR+1), K=KBAR+1,0,-1)
WRITE(MSG%LU_DEBUG,*) 'MGM-PART1: FVX'
WRITE(MSG%LU_DEBUG,MSG%CFORM2) ((MESHES(MYID+1)%FVX(I,1,K), I=0, IBAR), K=KBAR,0,-1)
#endif
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) ' ----------------------- PART2 of MGM: AFTER STRUCTURED'
WRITE(MSG%LU_DEBUG,*) 'MGM-PART2: MGM%H1'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((MGM%H1(I,1,K), I=0, IBAR+1), K=KBAR+1,0,-1)
WRITE(MSG%LU_DEBUG,*) 'MGM-PART2: MGM%H2'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((MGM%H2(I,1,K), I=0, IBAR+1), K=KBAR+1,0,-1)
WRITE(MSG%LU_DEBUG,*) 'MGM-PART2: MGM%U'
WRITE(MSG%LU_DEBUG,MSG%CFORM2) ((MGM%U(I,1,K), I=0, IBAR), K=KBAR,0,-1)
WRITE(MSG%LU_DEBUG,*) 'MGM-PART2: MGM%US'
WRITE(MSG%LU_DEBUG,MSG%CFORM2) ((MGM%US(I,1,K), I=0, IBAR), K=KBAR,0,-1)
WRITE(MSG%LU_DEBUG,*) 'MGM-PART2: FVX'
WRITE(MSG%LU_DEBUG,MSG%CFORM2) ((MESHES(MYID+1)%FVX(I,1,K), I=0, IBAR), K=KBAR,0,-1)
#endif
         CALL SCARC_MGM_VELOCITY_PROJECTION(NLEVEL_MIN)

#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) ' ----------------------- PART3 of MGM: AFTER PROJECTION'
WRITE(MSG%LU_DEBUG,*) 'MGM-PART3: MGM%H1'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((MGM%H1(I,1,K), I=0, IBAR+1), K=KBAR+1,0,-1)
WRITE(MSG%LU_DEBUG,*) 'MGM-PART3: MGM%H2'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((MGM%H2(I,1,K), I=0, IBAR+1), K=KBAR+1,0,-1)
WRITE(MSG%LU_DEBUG,*) 'MGM-PART3: MGM%U'
WRITE(MSG%LU_DEBUG,MSG%CFORM2) ((MGM%U(I,1,K), I=0, IBAR), K=KBAR,0,-1)
WRITE(MSG%LU_DEBUG,*) 'MGM-PART3: MGM%US'
WRITE(MSG%LU_DEBUG,MSG%CFORM2) ((MGM%US(I,1,K), I=0, IBAR), K=KBAR,0,-1)
WRITE(MSG%LU_DEBUG,*) 'MGM-PART3: FVX'
WRITE(MSG%LU_DEBUG,MSG%CFORM2) ((MESHES(MYID+1)%FVX(I,1,K), I=0, IBAR), K=KBAR,0,-1)
#endif
         CALL SCARC_MGM_VELOCITY_ERROR(NLEVEL_MIN)

#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) ' ----------------------- PART4 of MGM: AFTER ERROR'
WRITE(MSG%LU_DEBUG,*) 'MGM-PART4: MGM%H1'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((MGM%H1(I,1,K), I=0, IBAR+1), K=KBAR+1,0,-1)
WRITE(MSG%LU_DEBUG,*) 'MGM-PART4: MGM%H2'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((MGM%H2(I,1,K), I=0, IBAR+1), K=KBAR+1,0,-1)
WRITE(MSG%LU_DEBUG,*) 'MGM-PART4: MGM%U'
WRITE(MSG%LU_DEBUG,MSG%CFORM2) ((MGM%U(I,1,K), I=0, IBAR), K=KBAR,0,-1)
WRITE(MSG%LU_DEBUG,*) 'MGM-PART4: MGM%US'
WRITE(MSG%LU_DEBUG,MSG%CFORM2) ((MGM%US(I,1,K), I=0, IBAR), K=KBAR,0,-1)
WRITE(MSG%LU_DEBUG,*) 'MGM-PART4: FVX'
WRITE(MSG%LU_DEBUG,MSG%CFORM2) ((MESHES(MYID+1)%FVX(I,1,K), I=0, IBAR), K=KBAR,0,-1)
#endif
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) ' ----------------------- PART5 of MGM: AFTER PARTIAL SOLUTION'
WRITE(MSG%LU_DEBUG,*) 'MGM-PART5: MGM%H1'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((MGM%H1(I,1,K), I=0, IBAR+1), K=KBAR+1,0,-1)
WRITE(MSG%LU_DEBUG,*) 'MGM-PART5: MGM%H2'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((MGM%H2(I,1,K), I=0, IBAR+1), K=KBAR+1,0,-1)
WRITE(MSG%LU_DEBUG,*) 'MGM-PART5: MGM%U'
WRITE(MSG%LU_DEBUG,MSG%CFORM2) ((MGM%U(I,1,K), I=0, IBAR), K=KBAR,0,-1)
WRITE(MSG%LU_DEBUG,*) 'MGM-PART5: MGM%US'
WRITE(MSG%LU_DEBUG,MSG%CFORM2) ((MGM%US(I,1,K), I=0, IBAR), K=KBAR,0,-1)
WRITE(MSG%LU_DEBUG,*) 'MGM-PART5: FVX'
WRITE(MSG%LU_DEBUG,MSG%CFORM2) ((MESHES(MYID+1)%FVX(I,1,K), I=0, IBAR), K=KBAR,0,-1)
#endif

         CALL SCARC_MGM_VELOCITY_INTERNAL (NLEVEL_MIN)
         CALL SCARC_ASSIGN_GRID_TYPE (NSCARC_GRID_UNSTRUCTURED)
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) ' ----------------------- PART6 of MGM: AFTER UNSTRUCTURED'
WRITE(MSG%LU_DEBUG,*) 'MGM-PART6: MGM%H1'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((MGM%H1(I,1,K), I=0, IBAR+1), K=KBAR+1,0,-1)
WRITE(MSG%LU_DEBUG,*) 'MGM-PART6: MGM%H2'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((MGM%H2(I,1,K), I=0, IBAR+1), K=KBAR+1,0,-1)
WRITE(MSG%LU_DEBUG,*) 'MGM-PART6: MGM%U'
WRITE(MSG%LU_DEBUG,MSG%CFORM2) ((MGM%U(I,1,K), I=0, IBAR), K=KBAR,0,-1)
WRITE(MSG%LU_DEBUG,*) 'MGM-PART6: MGM%US'
WRITE(MSG%LU_DEBUG,MSG%CFORM2) ((MGM%US(I,1,K), I=0, IBAR), K=KBAR,0,-1)
WRITE(MSG%LU_DEBUG,*) 'MGM-PART6: FVX'
WRITE(MSG%LU_DEBUG,MSG%CFORM2) ((MESHES(MYID+1)%FVX(I,1,K), I=0, IBAR), K=KBAR,0,-1)
#endif

         CALL SCARC_EXCHANGE (NSCARC_EXCHANGE_MGM2, NSCARC_NONE, NLEVEL_MIN)
         CALL SCARC_MGM_PARTIAL_SOLUTION (NLEVEL_MIN, NSCARC_MGM_MERGE2)

#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) ' ----------------------- PART7 of MGM: AFTER MERGE'
WRITE(MSG%LU_DEBUG,*) 'MGM-PART7: H'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((MESHES(MYID+1)%H(I,1,K), I=0, IBAR+1), K=KBAR+1,0,-1)
WRITE(MSG%LU_DEBUG,*) 'MGM-PART7: HS'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((MESHES(MYID+1)%HS(I,1,K), I=0, IBAR+1), K=KBAR+1,0,-1)
WRITE(MSG%LU_DEBUG,*) 'MGM-PART7: MGM%H1'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((MGM%H1(I,1,K), I=0, IBAR+1), K=KBAR+1,0,-1)
WRITE(MSG%LU_DEBUG,*) 'MGM-PART7: MGM%H2'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((MGM%H2(I,1,K), I=0, IBAR+1), K=KBAR+1,0,-1)
WRITE(MSG%LU_DEBUG,*) 'MGM-PART7: MGM%U'
WRITE(MSG%LU_DEBUG,MSG%CFORM2) ((MGM%U(I,1,K), I=0, IBAR), K=KBAR,0,-1)
WRITE(MSG%LU_DEBUG,*) 'MGM-PART7: MGM%US'
WRITE(MSG%LU_DEBUG,MSG%CFORM2) ((MGM%US(I,1,K), I=0, IBAR), K=KBAR,0,-1)
WRITE(MSG%LU_DEBUG,*) 'MGM-PART7: FVX'
WRITE(MSG%LU_DEBUG,MSG%CFORM2) ((MESHES(MYID+1)%FVX(I,1,K), I=0, IBAR), K=KBAR,0,-1)
#endif
      ENDIF

   ! ---------------- McKenny-Greengard-Mayo method (MGM2) --------------------
 
   CASE (NSCARC_METHOD_MGM2)
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) ' ----------------------- PART1 of MGM: BEGINNING, BEFORE ALL '
#endif
      CALL SCARC_ASSIGN_GRID_TYPE(NSCARC_GRID_STRUCTURED)
      CALL SCARC_METHOD_KRYLOV (NSCARC_MGM_STACK_POISSON, NSCARC_STACK_ZERO, NSCARC_RHS_INHOMOGENEOUS, NLEVEL_MIN)
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) ' ----------------------- PART2 of MGM: AFTER STRUCTURED KRYLOV AND VELO SETTING '
WRITE(MSG%LU_DEBUG,*) 'MGM-PART2:2: H'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((MESHES(MYID+1)%H(I,1,K), I=0, IBAR+1), K=KBAR+1,0,-1)
WRITE(MSG%LU_DEBUG,*) 'MGM-PART2:2: HS'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((MESHES(MYID+1)%HS(I,1,K), I=0, IBAR+1), K=KBAR+1,0,-1)
WRITE(MSG%LU_DEBUG,*) 'MGM-PART2:2: MGM%H1'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((MGM%H1(I,1,K), I=0, IBAR+1), K=KBAR+1,0,-1)
WRITE(MSG%LU_DEBUG,*) 'MGM-PART2:2: MGM%H2'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((MGM%H2(I,1,K), I=0, IBAR+1), K=KBAR+1,0,-1)
#endif
      ...
      DO NM = LOWER_MESH_INDEX, UPPER_MESH_INDEX
         CALL SCARC_METHOD_MGM_LU(3, NM, NLEVEL_MIN)
      ENDDO

      IF (TYPE_MGM_INTERNAL == NSCARC_MGM_EXTRAPOLATION) CALL SCARC_MGM_PARTIAL_SOLUTION (NLEVEL_MIN, NSCARC_MGM_LEVEL2)
      CALL SCARC_MGM_PARTIAL_SOLUTION (NLEVEL_MIN, NSCARC_MGM_LAPLACE)
...
! Note: this is most probably no longer necessary because MESH_EXCHANGE(5) is used after the call of ScaRC
      ...
      CALL SCARC_EXCHANGE(NSCARC_EXCHANGE_PRESSURE, NSCARC_NONE, NLEVEL_MIN)

#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) ' ----------------------- PART3 of MGM: AFTER UNSTRUCTURED KRYLOV, GHOSTCELL SETTING '
WRITE(MSG%LU_DEBUG,*) 'MGM-PART3:3: H'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((MESHES(MYID+1)%H(I,1,K), I=0, IBAR+1), K=KBAR+1,0,-1)
WRITE(MSG%LU_DEBUG,*) 'MGM-PART3:3: HS'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((MESHES(MYID+1)%HS(I,1,K), I=0, IBAR+1), K=KBAR+1,0,-1)
WRITE(MSG%LU_DEBUG,*) 'MGM-PART2:3: MGM%H1'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((MGM%H1(I,1,K), I=0, IBAR+1), K=KBAR+1,0,-1)
WRITE(MSG%LU_DEBUG,*) 'MGM-PART2:3: MGM%H2'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((MGM%H2(I,1,K), I=0, IBAR+1), K=KBAR+1,0,-1)
#endif
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) '==================================================================================='
WRITE(MSG%LU_DEBUG,*) '================= SCARC_SOLVER : STOP: ICYC = ', ICYC
WRITE(MSG%LU_DEBUG,*) '==================================================================================='
WRITE(MSG%LU_DEBUG,*) ' ........... leaving ScaRC ............', PREDICTOR
WRITE(MSG%LU_DEBUG,*) 'SCARC_SOLVER:2: H'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((MESHES(MYID+1)%H(I,1,K), I=0, IBAR+1), K=KBAR+1,0,-1)
...
IF (TYPE_SOLVER == NSCARC_SOLVER_MAIN .AND. .NOT.(IS_MGM .AND. NSTACK == NSCARC_MGM_STACK_LAPLACE)) THEN
   CALL SCARC_UPDATE_MAINCELLS(NLEVEL_MIN)
   CALL SCARC_UPDATE_GHOSTCELLS(NLEVEL_MIN)
#ifdef WITH_SCARC_POSTPROCESSING
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,'(A,5i4,2E14.6)') 'MGM-BC: INTERNAL: IOR =  1: IW,I,J,K,IC,UU(IW),B(IC):', IW,I,J,K, IC, MGM%UU(IW), ST%B(IC)
#endif
                     CASE(-1)
                        ST%B(IC) = -L%DXI * DTI * MGM%UU(IW)
#ifdef WITH_SCARC_DEBUG
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,'(A,5i4,2E14.6)') 'MGM-BC: INTERNAL: IOR =  2: IW,I,J,K,IC,VV(IW),B(IC):', IW,I,J,K, IC, MGM%VV(IW), ST%B(IC)
#endif
                     CASE(-2)
                        ST%B(IC) = -L%DYI * DTI * MGM%VV(IW)
#ifdef WITH_SCARC_DEBUG
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,'(A,5i4,2E14.6)') 'MGM-BC: INTERNAL: IOR =  3: IW,I,J,K,IC,WW(IW),B(IC):', IW,I,J,K, IC, MGM%WW(IW), ST%B(IC)
#endif
                     CASE(-3)
                        ST%B(IC) = -L%DZI * DTI * MGM%WW(IW)
#ifdef WITH_SCARC_DEBUG
...
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((HP(I,1,K), I=0, L%NX+1), K=0,L%NZ+1)
#endif
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) 'EXCHANGE_MGM1: READ: NM, NOM, NL:', NM, NOM, NL
#endif
            CALL SCARC_RECV_MESSAGE_REAL (NM, NOM, NL, NSCARC_BUFFER_LAYER1, 'MGM1')

         CASE (NSCARC_EXCHANGE_MGM2)
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) 'EXCHANGE_MGM2: READ: NM, NOM, NL:', NM, NOM, NL
#endif
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) 'SCARC_EXCHANGE: PACK: NM, NOM, NL, SNODE, RNODE:', NM, NOM, NL, SNODE, RNODE
#endif
      SEND_PACK_OMESHES_SELECT: SELECT CASE (NTYPE)
         ...
         CASE (NSCARC_EXCHANGE_MGM2)
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) 'EXCHANGE_MGM2: PACKING'
#endif
            CALL SCARC_PACK_MGM2(NM, NL)
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) 'EXCHANGE_MGM2: SENDING:', NM, NOM, NL
WRITE(MSG%LU_DEBUG,*) 'SCARC(',NM,')%OSCARC(',NOM,')%SEND_BUFFER_REAL='
WRITE(MSG%LU_DEBUG,'(8E16.8)') SCARC(NM)%OSCARC(NOM)%SEND_BUFFER_REAL(1:16)
#endif
            CALL SCARC_SEND_MESSAGE_REAL (NM, NOM, NL, NSCARC_BUFFER_LAYER1, 'MGM2')
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) 'EXCHANGE_MGM2: SENDING - READY'
#endif
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) 'SCARC_EXCHANGE: UNPACK: NM, NOM, NL, SNODE, RNODE:', NM, NOM, NL, SNODE, RNODE
#endif
      SEND_UNPACK_OMESHES_SELECT: SELECT CASE (NTYPE)
         ...
         CASE (NSCARC_EXCHANGE_MGM2)
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) 'EXCHANGE_MGM2: UNPACKING:', NM, NOM
WRITE(MSG%LU_DEBUG,'(8E16.8)') SCARC(NM)%OSCARC(NOM)%RECV_BUFFER_REAL(1:16)
#endif
            CALL SCARC_UNPACK_MGM2 (NM, NOM, NL)
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) 'EXCHANGE_MGM2: UNPACKING - READY'
#endif
...
#ifdef WITH_SCARC_DEBUG        
WRITE(MSG%LU_DEBUG,*) 'M%SOLID', CELL_COUNT(NM)
WRITE(MSG%LU_DEBUG,'(12I4)') (MESHES(NM)%SOLID(I), I=1, CELL_COUNT(NM))
WRITE(MSG%LU_DEBUG,*) 'START OF PARTIAL SOLUTION:', L%NX, L%NZ
WRITE(MSG%LU_DEBUG,*) 'MGM%H1'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((MGM%H1(I,1,K), I=0, L%NX+1), K=L%NZ+1,0,-1)
WRITE(MSG%LU_DEBUG,*) 'MGM%H2'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((MGM%H2(I,1,K), I=0, L%NX+1), K=L%NZ+1,0,-1)
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,'(A, 3I6,1E16.8)') 'MGM:H1:PREDICTOR: IX, IY, IZ, H1:', IX, IY, IZ, MGM%H1(IX,IY,IZ)
#endif
               ENDDO
            ENDDO
         ENDDO
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,'(A, 3I6,1E16.8)') 'MGM:H1:CORRECTOR: IX, IY, IZ, H1:', IX, IY, IZ, MGM%H1(IX,IY,IZ)
#endif
               ENDDO
            ENDDO
         ENDDO
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,'(A, 4I6,1E16.8)') 'MGM:H1:A: IX, IY, IZ, ICS, H1:', IX, IY, IZ, ICS, MGM%H1(IX,IY,IZ)
#endif
               ENDDO
            ENDDO
         ENDDO
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,'(A, 5I6,1E16.8)') 'MGM:H1:B: IX, IY, IZ, IW, ICE, H1:', IX, IY, IZ, IW, ICE, MGM%H1(IX,IY,IZ)
#endif
         ENDDO
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,'(A, 4I6,1E16.8)') 'MGM:H3: IX, IY, IZ, ICU, H3:', &
                                              IX, IY, IZ, ICU, MGM%H3(IX,IY,IZ)
#endif
                  ENDDO
               ENDDO
            ENDDO
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,'(A, 4I6,1E16.8)') 'MGM:H2:A: IX, IY, IZ, ICU, H2:', IX, IY, IZ, ICU, MGM%H2(IX,IY,IZ)
#endif
               ENDDO
            ENDDO
         ENDDO
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,'(A, 3I6,3E16.8)') 'MGM:M: IX, IY, IZ, H1, H2, H:',  IX, IY, IZ, &
                                       MGM%H1(IX,IY,IZ), MGM%H2(IX,IY,IZ), HP(IX,IY,IZ)
#endif
               ENDDO
            ENDDO
         ENDDO
...
! ---------------------------------------------------------------------------------------------------------------
SUBROUTINE SCARC_MGM_VELOCITY_PROJECTION(NL)
USE SCARC_ITERATION_ENVIRONMENT
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) 'SET_VELOCITY_PROJECTION:1: MGM%H1'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((MGM%H1(I,1,K), I=0, M%IBAR+1), K=M%KBAR+1,0,-1)
WRITE(MSG%LU_DEBUG,*) 'SET_VELOCITY_PROJECTION:1: U'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((M%W(I,1,K), I=0, M%IBAR+1), K=M%KBAR+1,0,-1)
WRITE(MSG%LU_DEBUG,*) 'SET_VELOCITY_PROJECTION:1: US'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((M%US(I,1,K), I=0, M%IBAR+1), K=M%KBAR+1,0,-1)
WRITE(MSG%LU_DEBUG,*) 'SET_VELOCITY_PROJECTION:1: US'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((M%WS(I,1,K), I=0, M%IBAR+1), K=M%KBAR+1,0,-1)
#endif
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) '=================================PREDICTOR: ', PREDICTOR, M%IBAR, M%JBAR, M%KBAR
#endif
...
WRITE(*,*) I, J, K
#endif
               M%US(I,J,K) = M%U(I,J,K) - DT*( M%FVX(I,J,K) + M%RDXN(I)*(MGM%H1(I+1,J,K)-MGM%H1(I,J,K)) )
#ifdef WITH_SCARC_DEBUG
WRITE(*,'(A,3i4,5E16.8)') 'MGM-VELO X: ',I,J,K,M%U(I,J,K), M%FVX(I,J,K), MGM%H1(I+1,J,K), MGM%H1(I,J,K), M%US(I,J,K)
#endif
            ENDDO
         ENDDO
      ENDDO
      ...
      DO K=1,M%KBAR
         DO J=0,M%JBAR
            DO I=1,M%IBAR
               M%VS(I,J,K) = M%V(I,J,K) - DT*( M%FVY(I,J,K) + M%RDYN(J)*(MGM%H1(I,J+1,K)-MGM%H1(I,J,K)) )
#ifdef WITH_SCARC_DEBUG
WRITE(*,'(A,3i4,5E16.8)') 'MGM-VELO Y: ',I,J,K,M%V(I,J,K), M%FVY(I,J,K), MGM%H1(I,J+1,K), MGM%H1(I,J,K), M%VS(I,J,K)
#endif
            ENDDO
         ENDDO
      ENDDO
      ...
      DO K=0,M%KBAR
         DO J=1,M%JBAR
            DO I=1,M%IBAR
               M%WS(I,J,K) = M%W(I,J,K) - DT*( M%FVZ(I,J,K) + M%RDZN(K)*(MGM%H1(I,J,K+1)-MGM%H1(I,J,K)) )
#ifdef WITH_SCARC_DEBUG
WRITE(*,'(A,3i4,5E16.8)') 'MGM-VELO Z: ',I,J,K,M%W(I,J,K), M%FVZ(I,J,K), MGM%H1(I,J,K+1), MGM%H1(I,J,K), M%WS(I,J,K)
#endif
            ENDDO
         ENDDO
      ENDDO
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) '=================================CORRECTOR: ', PREDICTOR, M%IBAR, M%JBAR, M%KBAR
#endif
      ...
      DO K=1,M%KBAR
         DO J=1,M%JBAR
            DO I=0,M%IBAR
               M%U(I,J,K) = 0.5_EB*( M%U(I,J,K) + M%US(I,J,K) - DT*(M%FVX(I,J,K) + M%RDXN(I)*(MGM%H1(I+1,J,K)-MGM%H1(I,J,K))) )
            ENDDO
         ENDDO
      ENDDO
      ...
      DO K=1,M%KBAR
         DO J=0,M%JBAR
            DO I=1,M%IBAR
               M%V(I,J,K) = 0.5_EB*( M%V(I,J,K) + M%VS(I,J,K) - DT*(M%FVY(I,J,K) + M%RDYN(J)*(MGM%H1(I,J+1,K)-MGM%H1(I,J,K))) )
            ENDDO
         ENDDO
      ENDDO
      ...
      DO K=0,M%KBAR
         DO J=1,M%JBAR
            DO I=1,M%IBAR
               M%W(I,J,K) = 0.5_EB*( M%W(I,J,K) + M%WS(I,J,K) - DT*(M%FVZ(I,J,K) + M%RDZN(K)*(MGM%H1(I,J,K+1)-MGM%H1(I,J,K))) )
            ENDDO
         ENDDO
      ENDDO
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) 'SET_VELOCITY_PROJECTION:2: U'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((M%U(I,1,K), I=0, M%IBAR+1), K=M%KBAR+1,0,-1)
WRITE(MSG%LU_DEBUG,*) 'SET_VELOCITY_PROJECTION:2: U'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((M%W(I,1,K), I=0, M%IBAR+1), K=M%KBAR+1,0,-1)
WRITE(MSG%LU_DEBUG,*) 'SET_VELOCITY_PROJECTION:2: US'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((M%US(I,1,K), I=0, M%IBAR+1), K=M%KBAR+1,0,-1)
WRITE(MSG%LU_DEBUG,*) 'SET_VELOCITY_PROJECTION:2: US'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((M%WS(I,1,K), I=0, M%IBAR+1), K=M%KBAR+1,0,-1)
#endif
...
!> \brief Set internal boundary conditions for unstructured, homogeneous part of McKeeney-Greengard-Mayo method
! ---------------------------------------------------------------------------------------------------------------
SUBROUTINE SCARC_MGM_VELOCITY_ERROR(NL)
USE SCARC_ITERATION_ENVIRONMENT
USE SCARC_POINTERS, ONLY: M, L, MGM, GWC
INTEGER, INTENT(IN) :: NL
INTEGER :: NM, I, J, K, IW, IOR0
REAL(EB) :: UN_NEW_OTHER, UN_NEW, VELOCITY_ERROR, VELOCITY_ERROR_MAX = -1000.0_EB
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,'(A,4I4, 3E16.8)') 'MGM-VELO-ERR:SP: ',  IW, I, J, K, UN_NEW, UN_NEW_OTHER, UN_NEW - UN_NEW_OTHER
#endif
      ELSE
         SELECT CASE(ABS(IOR0))
            CASE (1)
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,'(A,4I4, 3E16.8)') 'MGM-VELO-ERR:SC: ',  IW, I, J, K, UN_NEW, UN_NEW_OTHER, UN_NEW - UN_NEW_OTHER
#endif
      ENDIF

      VELOCITY_ERROR = UN_NEW - UN_NEW_OTHER
      IF (ABS(VELOCITY_ERROR) > VELOCITY_ERROR_MAX) VELOCITY_ERROR_MAX = VELOCITY_ERROR
      

#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) 'VELOCITY_ERROR, VELOCITY_ERROR_MAX =', VELOCITY_ERROR, VELOCITY_ERROR_MAX
#endif
...
!> \brief Set internal boundary conditions for unstructured, homogeneous part of McKeeney-Greengard-Mayo method
! ---------------------------------------------------------------------------------------------------------------
SUBROUTINE SCARC_MGM_VELOCITY_INTERNAL(NL)
USE SCARC_ITERATION_ENVIRONMENT
...
WRITE(MSG%LU_DEBUG,*) 'SET_INTERNAL_VELO: FVX'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((M%FVX(I,1,K), I=0, M%IBAR+1), K=M%KBAR+1,0,-1)
WRITE(MSG%LU_DEBUG,*) 'SET_INTERNAL_VELO: FVZ'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((M%FVZ(I,1,K), I=0, M%IBAR+1), K=M%KBAR+1,0,-1)
WRITE(MSG%LU_DEBUG,*) 'SET_INTERNAL_VELO: UU'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((UU(I,1,K), I=0, M%IBAR+1), K=M%KBAR+1,0,-1)
WRITE(MSG%LU_DEBUG,*) 'SET_INTERNAL_VELO: WW'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((WW(I,1,K), I=0, M%IBAR+1), K=M%KBAR+1,0,-1)
WRITE(MSG%LU_DEBUG,*) 'SET_INTERNAL_VELO: HP-before'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((HP(I,1,K), I=0, M%IBAR+1), K=M%KBAR+1,0,-1)
#endif
...
END SUBROUTINE SCARC_MGM_VELOCITY_INTERNAL
...
DO NM = LOWER_MESH_INDEX, UPPER_MESH_INDEX
   DO NL = NLMIN, NLMAX
      ...
      CALL SCARC_ALLOCATE_REAL3(MGM%U, 0, L%NX, 0, L%NY, 0, L%NZ, NSCARC_INIT_ZERO, 'MGM%U', CROUTINE)
      CALL SCARC_ALLOCATE_REAL3(MGM%V, 0, L%NX, 0, L%NY, 0, L%NZ, NSCARC_INIT_ZERO, 'MGM%V', CROUTINE)
      CALL SCARC_ALLOCATE_REAL3(MGM%W, 0, L%NX, 0, L%NY, 0, L%NZ, NSCARC_INIT_ZERO, 'MGM%W', CROUTINE)

      CALL SCARC_ALLOCATE_REAL3(MGM%US, 0, L%NX, 0, L%NY, 0, L%NZ, NSCARC_INIT_ZERO, 'MGM%US', CROUTINE)
      CALL SCARC_ALLOCATE_REAL3(MGM%VS, 0, L%NX, 0, L%NY, 0, L%NZ, NSCARC_INIT_ZERO, 'MGM%VS', CROUTINE)
      CALL SCARC_ALLOCATE_REAL3(MGM%WS, 0, L%NX, 0, L%NY, 0, L%NZ, NSCARC_INIT_ZERO, 'MGM%WS', CROUTINE)
