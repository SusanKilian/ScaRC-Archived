...
INTEGER :: NM, NM2, NOM, IC, IA, NC_MACRO, NA_MACRO, INBR, N,  N_TOTAL
...
#ifdef WITH_SCARC_DEBUG
WRITE(*,*) MYID,': COUNTS_NBR:', COUNTS_NBR
WRITE(*,*) MYID,': DISPLS_NBR:', DISPLS_NBR
WRITE(*,*) MYID,': N_TOTAL=', N_TOTAL
#endif
...
WRITE(*,*) MYID, ':C'
#ifdef WITH_SCARC_DEBUG
WRITE(*,*) MYID,': INT_BUFFER1:', INT_BUFFER
#endif
...
DO NM = LOWER_MESH_INDEX, UPPER_MESH_INDEX
   AC  => SCARC(NM)%AC_MACRO
   ACS => SCARC(NM)%ACS_MACRO
   WRITE(*,*) MYID,': =============== ON MESH ', NM
   WRITE(*,*) MYID,': AC%ROW'
   WRITE(*,*) MYID,(AC%ROW(IC), IC=1, AC%N_ROW + 1)
   WRITE(*,*) MYID,': AC%COL'
   WRITE(*,*) MYID,(AC%COL(IA), IA=1, AC%N_VAL)
   WRITE(*,*) MYID,': AC%ROW'
   WRITE(*,*) MYID,(AC%VAL(IA), IA=1, AC%N_VAL)
   WRITE(*,*) MYID,': AC%ROW'
   WRITE(*,*) MYID,(ACS%ROW(IC), IC=1, ACS%N_ROW + 1)
   WRITE(*,*) MYID,': AC%COL'
   WRITE(*,*) MYID,(ACS%COL(IA), IA=1, ACS%N_VAL)
   WRITE(*,*) MYID,': AC%ROW'
   WRITE(*,*) MYID,(ACS%VAL(IA), IA=1, ACS%N_VAL)
ENDDO
#endif
