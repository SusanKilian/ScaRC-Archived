...
TYPE SCARC_GRID_TYPE
   ...
   ! Forward and backward permutation of grid numbering
   INTEGER, ALLOCATABLE, DIMENSION (:)   :: PERM_FW            !< Forward permutation vector grid renumbering
   INTEGER, ALLOCATABLE, DIMENSION (:)   :: PERM_BW            !< Backward permutation vector grid renumbering
   ...
   INTEGER :: NONZERO = NSCARC_ZERO_INT                        !< First nonzero cell number in case of permuted grids
