...
USE SCARC_CONSTANTS
USE SCARC_VARIABLES
USE SCARC_MESSAGE_SERVICES, ONLY: MSG, SCARC_DEBUG_CMATRIX
USE SCARC_ERROR_HANDLING, ONLY: SCARC_SHUTDOWN
USE SCARC_STACK_ADMINISTRATION, ONLY: STACK, SCARC_SETUP_STACK, SCARC_SETUP_REFERENCES
USE SCARC_MEMORY_MANAGER, ONLY: SCARC_ALLOCATE_INT1, SCARC_ALLOCATE_INT2, SCARC_ALLOCATE_INT3
