...
USE SCARC_POINTERS, ONLY: M, L, MGM
INTEGER, INTENT(IN) :: NL
INTEGER  :: NM, IW, II, JJ, KKK, IOR0, I, J, K
...
INTEGER, INTENT(IN) :: NL, NTYPE
INTEGER :: NM, I, J, K, IW, IOR0, III, KKK, IIO, IIO1, IIO2, JJO, JJO1, JJO2, KKO, KKO1, KKO2
...
DO NM = LOWER_MESH_INDEX, UPPER_MESH_INDEX
   ...
   DO IW = 1, L%N_WALL_CELLS_EXT + L%N_WALL_CELLS_INT
      ...
      DHFCT = 1.0_EB
      !IF (NTYPE == NSCARC_MGM_LAPLACE .AND. M%WALL(IW)%BOUNDARY_TYPE == SOLID_BOUNDARY) DHFCT = 0.0_EB
      IF (GWCWALL(IW)%BOUNDARY_TYPE == SOLID_BOUNDARY) DHFCT = 0.0_EB
