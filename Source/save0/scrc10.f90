...
! ================================================================================================================
MODULE SCARC_GLOBAL_VARIABLES
USE PRECISION_PARAMETERS
USE SCARC_GLOBAL_CONSTANTS
USE SCARC_TYPES, ONLY: SCARC_MESSAGE_TYPE, SCARC_CPU_TYPE
IMPLICIT NONE
...
TYPE (SCARC_MESSAGE_TYPE), SAVE, TARGET :: MSG                            !< Structure to print out various messages
TYPE (SCARC_CPU_TYPE), SAVE, DIMENSION(:), ALLOCATABLE, TARGET :: CPU     !< CPU-times of different routines

END MODULE SCARC_GLOBAL_VARIABLES
