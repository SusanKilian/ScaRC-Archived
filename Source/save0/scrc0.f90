...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,'(A, 4I6,1E16.8)') 'MGM:H3: IX, IY, IZ, ICU, H3:', IX, IY, IZ, ICU, MGM%H3(IX,IY,IZ)
#endif
                  ENDDO
               ENDDO
            ENDDO
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) 'SET_VELOCITY_PROJECTION:1: FVX'
...
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((M%W(I,1,K), I=0, M%IBAR), K=M%KBAR,0,-1)
WRITE(MSG%LU_DEBUG,*) 'SET_VELOCITY_PROJECTION:1: US'
WRITE(MSG%LU_DEBUG,MSG%CFORM3) ((M%US(I,1,K), I=0, M%IBAR), K=M%KBAR,0,-1)
#endif
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,'(A,3i4,5E16.8)') 'MGM-VELO X: ',I,J,K,M%U(I,J,K), M%FVX(I,J,K), MGM%H1(I+1,J,K), MGM%H1(I,J,K), M%US(I,J,K)
#endif
            ENDDO
         ENDDO
      ENDDO
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,'(A,3i4,5E16.8)') 'MGM-VELO Y: ',I,J,K,M%V(I,J,K), M%FVY(I,J,K), MGM%H1(I,J+1,K), MGM%H1(I,J,K), M%VS(I,J,K)
#endif
            ENDDO
         ENDDO
      ENDDO
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,'(A,3i4,5E16.8)') 'MGM-VELO Z: ',I,J,K,M%W(I,J,K), M%FVZ(I,J,K), MGM%H1(I,J,K+1), MGM%H1(I,J,K), M%WS(I,J,K)
#endif
            ENDDO
         ENDDO
      ENDDO
...
#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) 'VELOCITY_ERROR, VELOCITY_ERROR_MAX =', MGM%VELOCITY_ERROR, MGM%VELOCITY_ERROR_MAX
#endif
