...
INTEGER, PARAMETER :: NSCARC_MGM_FAILURE             = 16         !< Type of MGM pass: First (inhomogeneous Poisson)
INTEGER, PARAMETER :: NSCARC_MGM_SUCCESS             = 17         !< Type of MGM pass: First (inhomogeneous Poisson)
...
REAL (EB) :: TNOW
INTEGER :: IBAR, KBAR, ITE_MGM, MGM_STATE
...
SELECT_METHOD: SELECT CASE (TYPE_METHOD)
   ...
   CASE (NSCARC_METHOD_MGM)
      ...
      MGM_STATE = SCARC_MGM_CONVERGENCE_STATE (0)
      ...
      !
      IF (MGM_STATE /= NSCARC_MGM_SUCCESS) THEN
         ...
         MGM_CORRECTION_LOOP: DO ITE_MGM = 1, MGM%ITE_MAX
            ...
            MGM_STATE = SCARC_MGM_CONVERGENCE_STATE (ITE_MGM)

            IF (MGM_STATE == NSCARC_MGM_SUCCESS) EXIT MGM_CORRECTION_LOOP
      ...
      MGM_STATE = SCARC_MGM_CONVERGENCE_STATE (-1)
...
REAL(EB) :: UN_NEW_OTHER, UN_NEW, DHFCT, DUDT, DVDT, DWDT, VE
...
WRITE(MSG%LU_DEBUG,'(A25,4I4, E14.6)') 'VELO-ERR:SC: UN_NEW_OTHER:',  IW, I, J, K, UN_NEW_OTHER
      ...
      VE = UN_NEW - UN_NEW_OTHER
      IF (ABS(VE) > MGM%VELOCITY_ERROR) MGM%VELOCITY_ERROR = ABS(VE)

#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,'(A,4I4, 3E14.6)') '-----------------------------------------------------------------------> FINAL : ',&
                                      IW, I, J, K, UN_NEW, UN_NEW_OTHER, VE
#endif
...
MGM%VELOCITY_ERROR = RANK_REAL

#ifdef WITH_SCARC_DEBUG
WRITE(MSG%LU_DEBUG,*) '========================================================================================='
WRITE(MSG%LU_DEBUG,*) '============> ALL MESHES: VELOCITY_ERROR =', VELOCITY_ERROR
WRITE(MSG%LU_DEBUG,*) '========================================================================================='
#endif
