...
if nmesh == 1 
  filename = {'shunn3_1mesh_32_scarc_mms.csv','shunn3_1mesh_64_scarc_mms.csv','shunn3_1mesh_128_scarc_mms.csv','shunn3_1mesh_256_scarc_mms.csv','shunn3_1mesh_512_scarc_mms.csv'};
  nscale = 1;
elseif nmesh == 2 
  filename = {'shunn3_4mesh_32_scarc_mms.csv','shunn3_4mesh_64_scarc_mms.csv','shunn3_4mesh_128_scarc_mms.csv','shunn3_4mesh_256_scarc_mms.csv','shunn3_4mesh_512_scarc_mms.csv'};
  nscale = 4;
elseif nmesh == 4 
  filename = {'shunn3_16mesh_32_scarc_mms.csv','shunn3_16mesh_64_scarc_mms.csv','shunn3_16mesh_128_scarc_mms.csv','shunn3_16mesh_256_scarc_mms.csv','shunn3_16mesh_512_scarc_mms.csv'};
  nscale = 16;
else
  filename = {'shunn3_1mesh_32_scarc_mms.csv','shunn3_1mesh_64_scarc_mms.csv','shunn3_1mesh_128_scarc_mms.csv','shunn3_1mesh_256_scarc_mms.csv','shunn3_1mesh_512_scarc_mms.csv'};
  nscale = 1;
end
filename2 = {'shunn3_32_mms.csv','shunn3_64_mms.csv','shunn3_128_mms.csv','shunn3_256_mms.csv','shunn3_512_mms.csv'};
...
for n=1:length(filename)
    ...
    % M2 = importdata([datadir,filename2{n}],',',2); % collect FDS results
    ...
    % minH = [min_H, min_H2, min_Hd];
    % maxH = [max_H, max_H2, max_Hd];
    
    % figure(1)
    % surf(H_error);
    % axis([0 150 0 150 min(minH) max(maxH)])
